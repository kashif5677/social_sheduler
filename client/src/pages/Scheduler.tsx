...
const Scheduler = () => {
  ...
  return (
    <div className="flex flex-collg:flex-row gap-6 h-full">
      {/*  --Compose pane-- */}
          ...
          <form className="space-y-5" onSubmit={handleSchedule}>
                ...
                {PLATFORMS.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1.5 p-3 rounded-md bordr transition-all duration-150 ${active ? "bg-red-50 border-red-300 text-red-500 scale-103" : "border-slate-200 text-slate-500 hover:border-slate-300"}`}
                    >
            ...
            <div>
              ...
              {mediaFile ? (
                ...
                <label className="flex items-center justify-center gap-2 p-5 py-10 border-2 border-dashed border-slate-200 rounded-xl cursor-pointer hover:border-red-300 hover:border-red-300 hover:bg-red-50/30 transition-all group">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block txt-xs text-slate-500 uppercase mb-2">
                  Date
                </label>
