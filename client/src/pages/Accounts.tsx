...
const Accounts = () => {
  ...
  const [showPlatformPicker, setShowPlateformPicker] = useState(false);
  ...
  const fetchAccounts = async (
    ...
    console.log(isSync, platform, succesMsg);
  };
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-sm">
        ...
        <button
          onClick={() => setShowPlateformPicker(true)}
      ...
      {showPlatformPicker && (
        <PlatformPickerModal
          ...
          onClose={() => setShowPlateformPicker(false)}
